...
fputcsv($output, array('รหัสสถานบริการ','ชื่อสถานบริการ','ประเภทสถานบริการ','PID','CID','ชื่อสกุล','ที่อยู่','ปี','วันเกิด','อายุ','กลุ่มอายุ','เพศ','ตำบล','หมู่ที่','ขึ้นทะเบียนผู้ป่วยความดันสูง','ความดันสุง','systolic','diastolic','ผลวามดัน','ยังไม่ขึ้นทะเบียนเบาหวาน','เบาหวาน','เเบาหวานรายใหม่','วันวินิฉัยเบาหวาน','วันคัดกรองเบาหวาน','น้ำตาล','ผลเบาหวาน','HT_EYE','HT_KIDNEY','HT_HEART','HT_BRAIN','HT_FOOT','HT_OTHER','DM_EYE','DM_KIDNEY','DM_HEART','DM_BRAIN','DM_FOOT','DM_OTHER'));
...
$rows = mysql_query("SELECT HOSPCODE as 'รหัสสถานบริการ'
...
,IS_DM AS 'เบาหวาน'
,IS_DM_FIRST as 'เเบาหวานรายใหม่'
...
,CASE WHEN DM_RESULT IS NOT NULL THEN DM_RESULT ELSE 'no' END AS 'ผลเบาหวาน'
...
,CASE WHEN DM_COM_OTHER IS NOT NULL THEN 'Y' ELSE 'N' END AS 'DM_OTHER' FROM mas_person_onerecord_chronic_demo");
